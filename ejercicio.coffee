...
duracion (nombre,ano,duracion,director) = duracion
 
nombre :: Pelicula -> String
nombre (nombre,ano,duracion,director) = nombre

ano :: Pelicula -> Int
ano (nombre,ano,duracion,director) = ano
 
director :: Pelicula -> String
director (nombre,ano,duracion,director) = director
...
estrenos [] _ = []
estrenos (p:ps) x | (ano p) == x = (nombre p) : estrenos ps x
                  | (ano p) /= x = estrenos ps x
